<template>
  <BaseDialog title="Release by Major of Business" width="600">
    <template v-slot:default>
      <ShgAutocomplete v-model="searchText" label="Major of Business" :items="major" />
      <ShgCheckbox label="I'm aware of the action i'm doing" v-model="isAware" />
    </template>
...
import { BaseDialog, ShgAutocomplete, ShgButton, ShgCheckbox } from '@siloamhospitals/erp-template-vuetify-components';
